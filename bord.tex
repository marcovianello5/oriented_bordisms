...
\title{On $ 1 $-categories of $ 2 $-bordisms}
...
I'm writing this set of notes to try pin down to myself the details that underlies the definition of a category of bordisms suitable for stating and proving the folklore equivalence theorem between $ 2 $-dimensional topological quantum field theories and Frobenius algebras.

\todo[inline]{There are some flaws here and there.}
